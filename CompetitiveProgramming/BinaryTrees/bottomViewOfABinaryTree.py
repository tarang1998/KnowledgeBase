...
class Solution:
    ...
    def parseTree(self,node,level,horizontalDistance):
        ...
        #check if horizontal distance is present as key in the solution
        ...
        # Check for the level associated with the horizontal distance
        else:
            
            solutionLevel = self.solution[horizontalDistance][0]
    ...
    def bottomView(self, root):
        ...
        #key - horizontal distance of the node from the root
        #value - tuple (node level , val)
